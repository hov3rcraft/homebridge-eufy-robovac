...
See the dropdown on the plugin config page for a current list of supported devices.
Obviously, I can't test all models. I am using a RoboVac 15C.
If your device is not listed or if it is not working as expected, feel free to open an [issue](https://github.com/hov3rcraft/homebridge-eufy-robovac/issues).
...
- `model`: Select the correct model from the dropdown menu. If your device is not listed, you can try "default".
...
- [damacus](https://github.com/damacus) and all contributors on [damacus/robovac](https://github.com/damacus/robovac) - Figured out the device-specific commands for newer models
